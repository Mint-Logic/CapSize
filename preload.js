...
const ALLOWED_SEND_CHANNELS = [
    'resize-anchored', 'request-mode-switch', 'save-app-config', 'migrate-to-pro', 'update-setting', 'close-app', 'minimize-app', 'maximize-app',
    'force-maximize', 'resize-window', 'center-window', 'restore-window-size', 'set-always-on-top', 'set-window-opacity',
