...
`,
    ...
    @keyframes badgePulse {
       ...
       .guide-content { background: #0B0C0E; border: .1px solid rgba(140, 250, 150, 0.3); border-radius: 12px; width: 950px; height: 660px; display: flex; flex-direction: column; box-shadow: 0 15px 45px rgba(0,0,0,0.9), 0 0 30px rgba(140, 250, 150, 0.1); overflow: hidden; }
        ...
        .sidebar-section { margin-top: 15px; padding: 0 20px; font-size: 11px; font-weight: 800; color: #aaa; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 5px; border-bottom: 1px solid rgba(255,255,255,0.05); padding-bottom: 5px; }
        ...
        .setting-desc { color: #999; font-size: 11px; margin-top: 3px; max-width: 400px; }
...
input:checked + .slider:before { 
    ...
    box-shadow: 0 0 10px rgba(140, 250, 150, 0.2);
        ...
        .guide-close { font-size: 18px; color: #888; transition: 0.2s; cursor: pointer; padding: 5px; }
        .guide-close:hover { color: #c04040; transform: rotate(90deg); }
        .btn-reset { font-size: 10px; background: transparent; color: #aaa; border: 1px solid #444; padding: 2px 8px; cursor: pointer; border-radius: 3px; text-transform: uppercase; letter-spacing: 0.5px; }
...
#btn-check-updates:active {
    ...
    getOnboardingStyle: () => `
        ...
        .ob-slide .ob-sub { margin-top: 5px !important; color: #aaa; font-style: italic; font-size: 13px; max-width: 850px; } 
       ...
       /* --- CLEAN BUTTON PHYSICS (NO GLOW) --- */
        ...
        .about-ver { color: #999; font-size: 12px; margin-bottom: 0px; }
        .copyright-notice { margin-top: 0px; padding-top: 5px; text-align: center; font-size: 11px; color: #888; width: 100%; letter-spacing: 0.5px; }
                        ...
                        <div class="setting-group">
                            ...
                            <div class="setting-row" style="display: block;">
                                <div style="display:flex; justify-content:space-between; align-items:flex-start; margin-bottom: 10px;">
                                    <div class="setting-label">
                                        Font Library
                                        <div class="setting-desc">Click a font name to set it as Default. Pin favorites or hide unused fonts.</div>
                                    </div>
