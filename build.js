...
console.log(`\n🚀 STARTING TRANSPARENT BUILD: CapSize ${type.toUpperCase()}...\n`);
...
const config = isPro ? {
    name: "CapSize",
    id: "com.mintlogic.capsize",
    exe: "CapSize",
    artifact: "CapSize Pro Setup ${version}.${ext}",
    shortcut: "CapSize",
    uninstall: "CapSize"
} : {
    name: "CapSize",
    id: "com.mintlogic.capsize.core",
    exe: "CapSizeCore",
    artifact: "CapSize Core Setup ${version}.${ext}",
    shortcut: "CapSize",
    uninstall: "CapSize"
};
